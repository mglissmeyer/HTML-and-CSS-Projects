...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        audio('./media/buttonplace.mp3');
        //This condition checks to see if it is the computers turn.
        if (activePlayer === 'O') {
            //This funtion disables clicking for computers turn.
            disableClick();
    ...
    function computersTurn() {
        ...
        let success = false;
        //This variables stores a random number 0-8.
        let pickASquare;
        //This condition allows our while loop to keep trying if a square is selected already.
        while (!success) {
            //Arandom number between 0 and 8 is selected.
            pickASquare = String(Math.floor(Math.random() * 9));
            //If the randomnumber evaluated returns true, the square hasn't been selected yet.
...
function checkWinConditions() {
    ...
    // O 0, 4, 8 condition.
    else if (arrayIncludes('0O', '40', '80')) { drawWinLine(100, 100, 520, 90) }
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    //This line gives us access to our HTML canvas element.
    ...
    //This line disallows clicking while the win sound is playingg
    disableClick();
...
function resetGame() {
    ...
    //This resets our array so it is empty and we cans tart over.
    selectedSquares = [];
}